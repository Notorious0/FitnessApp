...
type NavigationProp = StackNavigationProp<RootStackParamList, "AddWorkoutScreen">;
...
const AddWorkoutScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Hangi Kas Grubunu Çalıştırmak İstiyorsun?</Text>
      <FlatList
        data={bodyParts}
